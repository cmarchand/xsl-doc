...
-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dxmlf="http://www.datypic.com/xmlf" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:local="http://www.datypic.com/local" xmlns:functx="http://www.functx.com" exclude-result-prefixes="dxmlf xs" version="3.0">
<!--
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:add-months" as="xs:date?">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:all-whitespace" as="xs:boolean">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:are-distinct-values" as="xs:boolean">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:atomic-type" as="xs:string*">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:avg-empty-is-zero" as="xs:double">
<xsl:param name="values" as="xs:anyAtomicType*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:between-exclusive" as="xs:boolean">
...
<!--
 ...
 @param   $maxValue the maximum value 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:between-inclusive" as="xs:boolean">
<xsl:param name="value" as="xs:anyAtomicType?"/>
<xsl:param name="minValue" as="xs:anyAtomicType"/>
<xsl:param name="maxValue" as="xs:anyAtomicType"/>
<xsl:sequence select=" $value >= $minValue and $value &lt;= $maxValue "/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:camel-case-to-words" as="xs:string">
<xsl:param name="arg" as="xs:string?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:capitalize-first" as="xs:string?">
<xsl:param name="arg" as="xs:string?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:change-element-names-deep" as="node()*">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:change-element-ns-deep" as="node()*">
<xsl:param name="nodes" as="node()*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:chars" as="xs:string*">
<xsl:param name="arg" as="xs:string?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:contains-any-of" as="xs:boolean">
<xsl:param name="arg" as="xs:string?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:contains-word" as="xs:boolean">
<xsl:param name="arg" as="xs:string?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:copy-attributes" as="element()">
...
<!--
 ...
 @param   $day the day 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:date" as="xs:date">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:dateTime" as="xs:dateTime">
<xsl:param name="year" as="xs:anyAtomicType"/>
<xsl:param name="month" as="xs:anyAtomicType"/>
<xsl:param name="day" as="xs:anyAtomicType"/>
...
<!--
 ...
 @param   $date the date 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:day-in-year" as="xs:integer?">
<xsl:param name="date" as="xs:anyAtomicType?"/>
...
<!--
 ...
 @param   $date the date 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:day-of-week-abbrev-en" as="xs:string?">
<xsl:param name="date" as="xs:anyAtomicType?"/>
...
<!--
 ...
 @param   $date the date 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:day-of-week-name-en" as="xs:string?">
<xsl:param name="date" as="xs:anyAtomicType?"/>
...
<!--
 ...
 @param   $date the date 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:day-of-week" as="xs:integer?">
<xsl:param name="date" as="xs:anyAtomicType?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:dayTimeDuration" as="xs:dayTimeDuration">
...
<!--
 ...
 @param   $date the date 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:days-in-month" as="xs:integer?">
<xsl:param name="date" as="xs:anyAtomicType?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:depth-of-node" as="xs:integer">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:distinct-attribute-names" as="xs:string*">
<xsl:param name="nodes" as="node()*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:distinct-deep" as="node()*">
<xsl:param name="nodes" as="node()*"/>
<xsl:sequence select=" for $seq in (1 to count($nodes)) return $nodes[$seq][not(functx:is-node-in-sequence-deep-equal(
    .,$nodes[position() &lt; $seq]))] "/>
</xsl:function>
<!--
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:distinct-element-names" as="xs:string*">
<xsl:param name="nodes" as="node()*"/>
...
<!--
 ...
 @param   $nodes the root(s) to start from 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:distinct-element-paths" as="xs:string*">
<xsl:param name="nodes" as="node()*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:distinct-nodes" as="node()*">
<xsl:param name="nodes" as="node()*"/>
<xsl:sequence select=" for $seq in (1 to count($nodes)) return $nodes[$seq][not(functx:is-node-in-sequence(
    .,$nodes[position() &lt; $seq]))] "/>
</xsl:function>
<!--
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:duration-from-timezone" as="xs:dayTimeDuration">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:dynamic-path" as="item()*">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:escape-for-regex" as="xs:string">
<xsl:param name="arg" as="xs:string?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:exclusive-or" as="xs:boolean?">
...
<!--
 ...
 @param   $date the date 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:first-day-of-month" as="xs:date?">
<xsl:param name="date" as="xs:anyAtomicType?"/>
...
<!--
 ...
 @param   $date the date 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:first-day-of-year" as="xs:date?">
<xsl:param name="date" as="xs:anyAtomicType?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:first-node" as="node()?">
<xsl:param name="nodes" as="node()*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:follows-not-descendant" as="xs:boolean">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:format-as-title-en" as="xs:string*">
...
<!--
 ...
 @param   $uri the URI 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:fragment-from-uri" as="xs:string?">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:has-element-only-content" as="xs:boolean">
...
<!--
 ...
 @param   $element the XML element to test 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:has-empty-content" as="xs:boolean">
<xsl:param name="element" as="element()"/>
...
<!--
 ...
 @param   $element the XML element to test 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:has-mixed-content" as="xs:boolean">
<xsl:param name="element" as="element()"/>
...
<!--
 ...
 @param   $element the XML element to test 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:has-simple-content" as="xs:boolean">
<xsl:param name="element" as="element()"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:id-from-element" as="xs:string?">
<xsl:param name="element" as="element()?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:id-untyped" as="element()*">
<xsl:param name="node" as="node()*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:if-absent" as="item()*">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:if-empty" as="item()*">
<xsl:param name="arg" as="item()?"/>
<xsl:param name="value" as="item()*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:index-of-deep-equal-node" as="xs:integer*">
<xsl:param name="nodes" as="node()*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:index-of-match-first" as="xs:integer?">
<xsl:param name="arg" as="xs:string?"/>
...
<!--
 ...
 @param   $nodeToFind the node to find in the sequence 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:index-of-node" as="xs:integer*">
<xsl:param name="nodes" as="node()*"/>
<xsl:param name="nodeToFind" as="node()"/>
...
<!--
 ...
 @param   $substring the substring to find 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:index-of-string-first" as="xs:integer?">
<xsl:param name="arg" as="xs:string?"/>
<xsl:param name="substring" as="xs:string"/>
...
<!--
 ...
 @param   $substring the substring to find 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:index-of-string-last" as="xs:integer?">
<xsl:param name="arg" as="xs:string?"/>
<xsl:param name="substring" as="xs:string"/>
...
<!--
 ...
 @param   $substring the substring to find 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:index-of-string" as="xs:integer*">
<xsl:param name="arg" as="xs:string?"/>
<xsl:param name="substring" as="xs:string"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:insert-string" as="xs:string">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:is-a-number" as="xs:boolean">
<xsl:param name="value" as="xs:anyAtomicType?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:is-absolute-uri" as="xs:boolean">
<xsl:param name="uri" as="xs:string?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:is-ancestor" as="xs:boolean">
...
<!--
 ...
 @param   $node2 the second node 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:is-descendant" as="xs:boolean">
<xsl:param name="node1" as="node()"/>
<xsl:param name="node2" as="node()"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:is-leap-year" as="xs:boolean">
<xsl:param name="date" as="xs:anyAtomicType?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:is-node-among-descendants-deep-equal" as="xs:boolean">
<xsl:param name="node" as="node()?"/>
...
<!--
 ...
 @param   $seq the sequence of nodes to search 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:is-node-among-descendants" as="xs:boolean">
<xsl:param name="node" as="node()?"/>
<xsl:param name="seq" as="node()*"/>
...
<!--
 ...
 @param   $seq the sequence of nodes to search 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:is-node-in-sequence-deep-equal" as="xs:boolean">
<xsl:param name="node" as="node()?"/>
<xsl:param name="seq" as="node()*"/>
...
<!--
 ...
 @param   $seq the sequence of nodes to search 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:is-node-in-sequence" as="xs:boolean">
<xsl:param name="node" as="node()?"/>
<xsl:param name="seq" as="node()*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:is-value-in-sequence" as="xs:boolean">
<xsl:param name="value" as="xs:anyAtomicType?"/>
<xsl:param name="seq" as="xs:anyAtomicType*"/>
...
<!--
 ...
 @param   $date the date 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:last-day-of-month" as="xs:date?">
<xsl:param name="date" as="xs:anyAtomicType?"/>
...
<!--
 ...
 @param   $date the date 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:last-day-of-year" as="xs:date?">
<xsl:param name="date" as="xs:anyAtomicType?"/>
...
<!--
 ...
 @param   $nodes the sequence of nodes 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:last-node" as="node()?">
<xsl:param name="nodes" as="node()*"/>
...
<!--
 ...
 @param   $root the root 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:leaf-elements" as="element()*">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:left-trim" as="xs:string">
<xsl:param name="arg" as="xs:string?"/>
...
<!--
 ...
 @param   $arg the string to test 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:line-count" as="xs:integer">
<xsl:param name="arg" as="xs:string?"/>
...
<!--
 ...
 @param   $arg the string to split 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:lines" as="xs:string*">
<xsl:param name="arg" as="xs:string?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:max-depth" as="xs:integer?">
<xsl:param name="root" as="node()?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:max-determine-type" as="xs:anyAtomicType?">
<xsl:param name="seq" as="xs:anyAtomicType*"/>
...
<!--
 ...
 @param   $nodes the sequence of nodes to test 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:max-node" as="node()*">
<xsl:param name="nodes" as="node()*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:max-string" as="xs:string?">
...
<!--
 ...
 @param   $seq the sequence of values to test 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:min-determine-type" as="xs:anyAtomicType?">
<xsl:param name="seq" as="xs:anyAtomicType*"/>
...
<!--
 ...
 @param   $nodes the sequence of nodes to test 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:min-node" as="node()*">
<xsl:param name="nodes" as="node()*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:min-non-empty-string" as="xs:string?">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:min-string" as="xs:string?">
<xsl:param name="strings" as="xs:anyAtomicType*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:mmddyyyy-to-date" as="xs:date?">
...
<!--
 ...
 @param   $date the date 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:month-abbrev-en" as="xs:string?">
<xsl:param name="date" as="xs:anyAtomicType?"/>
...
<!--
 ...
 @param   $date the date 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:month-name-en" as="xs:string?">
<xsl:param name="date" as="xs:anyAtomicType?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:name-test" as="xs:boolean">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:namespaces-in-use" as="xs:anyURI*">
<xsl:param name="root" as="node()?"/>
...
<!--
 ...
 @param   $date the date 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:next-day" as="xs:date?">
<xsl:param name="date" as="xs:anyAtomicType?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:node-kind" as="xs:string*">
<xsl:param name="nodes" as="node()*"/>
...
<!--
 ...
 @param   $seq the sequence of values 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:non-distinct-values" as="xs:anyAtomicType*">
<xsl:param name="seq" as="xs:anyAtomicType*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:ordinal-number-en" as="xs:string">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:pad-integer-to-length" as="xs:string">
...
<!--
 ...
 @param   $length the desired length 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:pad-string-to-length" as="xs:string">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:path-to-node-with-pos" as="xs:string">
<xsl:param name="node" as="node()?"/>
...
<!--
 ...
 @param   $nodes the node sequence 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:path-to-node" as="xs:string*">
<xsl:param name="nodes" as="node()*"/>
...
<!--
 ...
 @param   $b the second node 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:precedes-not-ancestor" as="xs:boolean">
<xsl:param name="a" as="node()?"/>
<xsl:param name="b" as="node()?"/>
...
<!--
 ...
 @param   $date the date 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:previous-day" as="xs:date?">
<xsl:param name="date" as="xs:anyAtomicType?"/>
<xsl:sequence select=" xs:date($date) - xs:dayTimeDuration('P1D') "/>
</xsl:function>
<!--
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:remove-attributes-deep" as="node()*">
<xsl:param name="nodes" as="node()*"/>
<xsl:param name="names" as="xs:string*"/>
<xsl:for-each select="$nodes">
<xsl:choose>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:remove-elements-deep" as="node()*">
<xsl:param name="nodes" as="node()*"/>
<xsl:param name="names" as="xs:string*"/>
<xsl:for-each select="$nodes">
<xsl:choose>
...
<!--
 ...
 @param   $names the names of the elements to remove 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:remove-elements-not-contents" as="node()*">
<xsl:param name="nodes" as="node()*"/>
<xsl:param name="names" as="xs:string*"/>
<xsl:for-each select="$nodes">
<xsl:choose>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:remove-elements" as="element()*">
<xsl:param name="elements" as="element()*"/>
<xsl:param name="names" as="xs:string*"/>
<xsl:for-each select="$elements">
<xsl:element name="{node-name(.)}">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:repeat-string" as="xs:string">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:replace-beginning" as="xs:string">
<xsl:param name="arg" as="xs:string?"/>
<xsl:param name="pattern" as="xs:string"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:replace-element-values" as="element()*">
<xsl:param name="elements" as="element()*"/>
<xsl:param name="values" as="xs:anyAtomicType*"/>
<xsl:for-each select="$elements">
<xsl:variable name="seq" select="position()"/>
...
<!--
 ...
 @param   $replacement the replacement string 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:replace-first" as="xs:string">
<xsl:param name="arg" as="xs:string?"/>
<xsl:param name="pattern" as="xs:string"/>
<xsl:param name="replacement" as="xs:string"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:replace-multi" as="xs:string?">
<xsl:param name="arg" as="xs:string?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:reverse-string" as="xs:string">
<xsl:param name="arg" as="xs:string?"/>
...
<!--
 ...
 @param   $arg the string to trim 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:right-trim" as="xs:string">
<xsl:param name="arg" as="xs:string?"/>
<xsl:sequence select=" replace($arg,'\s+$','') "/>
</xsl:function>
<!--
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:sequence-deep-equal" as="xs:boolean">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:sequence-node-equal-any-order" as="xs:boolean">
...
<!--
 ...
 @param   $seq2 the second sequence of nodes 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:sequence-node-equal" as="xs:boolean">
<xsl:param name="seq1" as="node()*"/>
<xsl:param name="seq2" as="node()*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:sequence-type" as="xs:string">
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:siblings-same-name" as="element()*">
<xsl:param name="element" as="element()?"/>
...
<!--
 ...
 @param   $node the node 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:siblings" as="node()*">
<xsl:param name="node" as="node()?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:sort-as-numeric" as="item()*">
...
<!--
 ...
 @param   $seq the sequence to sort 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:sort-case-insensitive" as="item()*">
<xsl:param name="seq" as="item()*"/>
<xsl:for-each select="$seq">
...
<!--
 ...
 @param   $seq the sequence to sort 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:sort-document-order" as="node()*">
<xsl:param name="seq" as="node()*"/>
...
<!--
 ...
 @param   $seq the sequence to sort 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:sort" as="item()*">
<xsl:param name="seq" as="item()*"/>
<xsl:for-each select="$seq">
<xsl:sort select="."/>
<xsl:copy-of select="."/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:substring-after-if-contains" as="xs:string?">
<xsl:param name="arg" as="xs:string?"/>
<xsl:param name="delim" as="xs:string"/>
...
<!--
 ...
 @param   $regex the regular expression 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:substring-after-match" as="xs:string?">
<xsl:param name="arg" as="xs:string?"/>
<xsl:param name="regex" as="xs:string"/>
<xsl:sequence select=" replace($arg,concat('^.*?',$regex),'') "/>
</xsl:function>
<!--
 ...
 @param   $delim the delimiter 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:substring-before-if-contains" as="xs:string?">
<xsl:param name="arg" as="xs:string?"/>
<xsl:param name="delim" as="xs:string"/>
...
<!--
 ...
 @param   $delim the delimiter 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:substring-before-last" as="xs:string">
<xsl:param name="arg" as="xs:string?"/>
<xsl:param name="delim" as="xs:string"/>
...
<!--
 ...
 @param   $second the second 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:time" as="xs:time">
<xsl:param name="hour" as="xs:anyAtomicType"/>
<xsl:param name="minute" as="xs:anyAtomicType"/>
<xsl:param name="second" as="xs:anyAtomicType"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:timezone-from-duration" as="xs:string">
...
<!--
 ...
 @param   $duration the duration 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:total-days-from-duration" as="xs:decimal?">
<xsl:param name="duration" as="xs:dayTimeDuration?"/>
...
<!--
 ...
 @param   $duration the duration 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:total-hours-from-duration" as="xs:decimal?">
<xsl:param name="duration" as="xs:dayTimeDuration?"/>
...
<!--
 ...
 @param   $duration the duration 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:total-minutes-from-duration" as="xs:decimal?">
<xsl:param name="duration" as="xs:dayTimeDuration?"/>
...
<!--
 ...
 @param   $duration the duration 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:total-months-from-duration" as="xs:decimal?">
...
<!--
 ...
 @param   $duration the duration 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:total-seconds-from-duration" as="xs:decimal?">
<xsl:param name="duration" as="xs:dayTimeDuration?"/>
...
<!--
 ...
 @param   $duration the duration 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:total-years-from-duration" as="xs:decimal?">
<xsl:param name="duration" as="xs:yearMonthDuration?"/>
...
<!--
 ...
 @param   $arg the string to trim 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:trim" as="xs:string">
<xsl:param name="arg" as="xs:string?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:value-except" as="xs:anyAtomicType*">
...
<!--
 ...
 @param   $arg2 the second sequence 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:value-union" as="xs:anyAtomicType*">
<xsl:param name="arg1" as="xs:anyAtomicType*"/>
<xsl:param name="arg2" as="xs:anyAtomicType*"/>
<xsl:sequence select=" distinct-values(($arg1, $arg2)) "/>
</xsl:function>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:word-count" as="xs:integer">
<xsl:param name="arg" as="xs:string?"/>
...
<!--
 ...
 @param   $arg the string to modify 
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:words-to-camel-case" as="xs:string">
<xsl:param name="arg" as="xs:string?"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:wrap-values-in-elements" as="element()*">
<xsl:param name="values" as="xs:anyAtomicType*"/>
...
-->
<xsl:function xmlns:functx="http://www.functx.com" name="functx:yearMonthDuration" as="xs:yearMonthDuration">
